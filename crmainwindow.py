...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem2 = QtGui.QSpacerItem(518, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.textBrowser_Total = QtGui.QTextBrowser(self.groupBox)
        ...
        self.textBrowser_Accepted = QtGui.QTextBrowser(self.groupBox)
        ...
        self.textBrowser_Reviewed = QtGui.QTextBrowser(self.groupBox)
        ...
        spacerItem3 = QtGui.QSpacerItem(498, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_23.addItem(spacerItem3)
        self.pushButton_Statistics = QtGui.QPushButton(self.groupBox)
        ...
        self.horizontalLayout_filtervalues = QtGui.QHBoxLayout()
        self.horizontalLayout_filtervalues.setObjectName("horizontalLayout_filtervalues")
        self.verticalLayout_fnameandbox = QtGui.QVBoxLayout()
        self.verticalLayout_fnameandbox.setObjectName("verticalLayout_fnameandbox")
        self.label_Filename = QtGui.QLabel(self.groupBox_Violations)
        self.label_Filename.setObjectName("label_Filename")
        self.verticalLayout_fnameandbox.addWidget(self.label_Filename)
        self.textBrowser_Filename = QtGui.QTextBrowser(self.groupBox_Violations)
        self.textBrowser_Filename.setObjectName("textBrowser_Filename")
        self.verticalLayout_fnameandbox.addWidget(self.textBrowser_Filename)
        self.horizontalLayout_filtervalues.addLayout(self.verticalLayout_fnameandbox)
        self.verticalLayout_fnnameandbox = QtGui.QVBoxLayout()
        self.verticalLayout_fnnameandbox.setObjectName("verticalLayout_fnnameandbox")
        self.label_Function = QtGui.QLabel(self.groupBox_Violations)
        self.label_Function.setObjectName("label_Function")
        self.verticalLayout_fnnameandbox.addWidget(self.label_Function)
        self.textBrowser_Function = QtGui.QTextBrowser(self.groupBox_Violations)
        self.textBrowser_Function.setObjectName("textBrowser_Function")
        self.verticalLayout_fnnameandbox.addWidget(self.textBrowser_Function)
        self.horizontalLayout_filtervalues.addLayout(self.verticalLayout_fnnameandbox)
        self.verticalLayout_severityandbox = QtGui.QVBoxLayout()
        self.verticalLayout_severityandbox.setObjectName("verticalLayout_severityandbox")
        self.label_6 = QtGui.QLabel(self.groupBox_Violations)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_severityandbox.addWidget(self.label_6)
        self.textBrowser_Severity = QtGui.QTextBrowser(self.groupBox_Violations)
        self.textBrowser_Severity.setObjectName("textBrowser_Severity")
        self.verticalLayout_severityandbox.addWidget(self.textBrowser_Severity)
        self.horizontalLayout_filtervalues.addLayout(self.verticalLayout_severityandbox)
        self.verticalLayout_idandbox = QtGui.QVBoxLayout()
        self.verticalLayout_idandbox.setObjectName("verticalLayout_idandbox")
        self.label_Id = QtGui.QLabel(self.groupBox_Violations)
        self.label_Id.setObjectName("label_Id")
        self.verticalLayout_idandbox.addWidget(self.label_Id)
        self.textBrowser_Id = QtGui.QTextBrowser(self.groupBox_Violations)
        self.textBrowser_Id.setObjectName("textBrowser_Id")
        self.verticalLayout_idandbox.addWidget(self.textBrowser_Id)
        self.horizontalLayout_filtervalues.addLayout(self.verticalLayout_idandbox)
        self.verticalLayout_dbyandbox = QtGui.QVBoxLayout()
        self.verticalLayout_dbyandbox.setObjectName("verticalLayout_dbyandbox")
        self.label_DetectedBy = QtGui.QLabel(self.groupBox_Violations)
        self.label_DetectedBy.setObjectName("label_DetectedBy")
        self.verticalLayout_dbyandbox.addWidget(self.label_DetectedBy)
        self.textBrowser_DetectedBy = QtGui.QTextBrowser(self.groupBox_Violations)
        self.textBrowser_DetectedBy.setObjectName("textBrowser_DetectedBy")
        self.verticalLayout_dbyandbox.addWidget(self.textBrowser_DetectedBy)
        self.horizontalLayout_filtervalues.addLayout(self.verticalLayout_dbyandbox)
        self.verticalLayout_8.addLayout(self.horizontalLayout_filtervalues)
        ...
        self.textBrowser_Reviewer = QtGui.QTextBrowser(self.groupBox_Analysis)
        self.textBrowser_Reviewer.setObjectName("textBrowser_Reviewer")
        self.horizontalLayout_14.addWidget(self.textBrowser_Reviewer)
        self.label_4 = QtGui.QLabel(self.groupBox_Analysis)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_14.addWidget(self.label_4)
        self.textBrowser_Date = QtGui.QTextBrowser(self.groupBox_Analysis)
        ...
        self.label_prevName = QtGui.QLabel(self.groupBox_Analysis)
        self.label_prevName.setObjectName("label_prevName")
        self.horizontalLayout_17.addWidget(self.label_prevName)
        self.textBrowser_PrevReviewer = QtGui.QTextBrowser(self.groupBox_Analysis)
        ...
        self.textBrowser_PrevDate = QtGui.QTextBrowser(self.groupBox_Analysis)
        ...
        self.textBrowser_PrevStatus = QtGui.QTextBrowser(self.groupBox_Analysis)
