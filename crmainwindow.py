...
#
# Created: Thu Jul 12 17:35:45 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 11, 837, 521))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 230, 621, 171))
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget1 = QtGui.QWidget(self.groupBox)
        self.layoutWidget1.setGeometry(QtCore.QRect(8, 20, 597, 138))
        ...
        self.textBrowser_Total = QtGui.QTextBrowser(self.layoutWidget1)
        self.textBrowser_Total.setMaximumSize(QtCore.QSize(139, 29))
        self.textBrowser_Total.setObjectName("textBrowser_Total")
        self.horizontalLayout_9.addWidget(self.textBrowser_Total)
        ...
        self.textBrowser_Accepted = QtGui.QTextBrowser(self.layoutWidget1)
        self.textBrowser_Accepted.setMaximumSize(QtCore.QSize(139, 29))
        self.textBrowser_Accepted.setObjectName("textBrowser_Accepted")
        self.horizontalLayout_10.addWidget(self.textBrowser_Accepted)
        ...
        self.textBrowser_Reviewed = QtGui.QTextBrowser(self.layoutWidget1)
        self.textBrowser_Reviewed.setMaximumSize(QtCore.QSize(137, 29))
        self.textBrowser_Reviewed.setObjectName("textBrowser_Reviewed")
        self.horizontalLayout_11.addWidget(self.textBrowser_Reviewed)
        ...
        self.pushButton_Statistics = QtGui.QPushButton(self.layoutWidget1)
        self.pushButton_Statistics.setObjectName("pushButton_Statistics")
        self.horizontalLayout_23.addWidget(self.pushButton_Statistics)
        self.verticalLayout_3.addLayout(self.horizontalLayout_23)
        self.groupBox_2 = QtGui.QGroupBox(self.tab_Config)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 10, 621, 211))
        ...
        spacerItem3 = QtGui.QSpacerItem(518, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.groupBox_Analysis.setGeometry(QtCore.QRect(10, 320, 811, 129))
        self.groupBox_Analysis.setMinimumSize(QtCore.QSize(809, 129))
        self.groupBox_Analysis.setObjectName("groupBox_Analysis")
        self.widget = QtGui.QWidget(self.groupBox_Analysis)
        self.widget.setGeometry(QtCore.QRect(10, 20, 791, 91))
        ...
        self.plainTextEdit_Analysis = QtGui.QPlainTextEdit(self.widget)
        ...
        self.textBrowser_Reviewer = QtGui.QTextBrowser(self.widget)
        self.textBrowser_Reviewer.setObjectName("textBrowser_Reviewer")
        self.horizontalLayout_14.addWidget(self.textBrowser_Reviewer)
        self.label_4 = QtGui.QLabel(self.widget)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_14.addWidget(self.label_4)
        self.textBrowser_Date = QtGui.QTextBrowser(self.widget)
        self.textBrowser_Date.setObjectName("textBrowser_Date")
        self.horizontalLayout_14.addWidget(self.textBrowser_Date)
        self.horizontalLayout_16.addLayout(self.horizontalLayout_14)
        self.horizontalLayout_15 = QtGui.QHBoxLayout()
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.pushButton_MarkReviewed = QtGui.QPushButton(self.widget)
        self.pushButton_MarkReviewed.setObjectName("pushButton_MarkReviewed")
        self.horizontalLayout_15.addWidget(self.pushButton_MarkReviewed)
        self.pushButton_MarkAccepted = QtGui.QPushButton(self.widget)
        self.pushButton_MarkAccepted.setObjectName("pushButton_MarkAccepted")
        self.horizontalLayout_15.addWidget(self.pushButton_MarkAccepted)
        ...
        self.label_prevName = QtGui.QLabel(self.widget)
        self.label_prevName.setObjectName("label_prevName")
        self.horizontalLayout_17.addWidget(self.label_prevName)
        self.textBrowser_PrevReviewer = QtGui.QTextBrowser(self.widget)
        self.textBrowser_PrevReviewer.setObjectName("textBrowser_PrevReviewer")
        self.horizontalLayout_17.addWidget(self.textBrowser_PrevReviewer)
        self.verticalLayout_5.addLayout(self.horizontalLayout_17)
        self.horizontalLayout_18 = QtGui.QHBoxLayout()
        self.horizontalLayout_18.setObjectName("horizontalLayout_18")
        self.label_PrevDate = QtGui.QLabel(self.widget)
        self.label_PrevDate.setObjectName("label_PrevDate")
        self.horizontalLayout_18.addWidget(self.label_PrevDate)
        self.textBrowser_PrevDate = QtGui.QTextBrowser(self.widget)
        self.textBrowser_PrevDate.setObjectName("textBrowser_PrevDate")
        self.horizontalLayout_18.addWidget(self.textBrowser_PrevDate)
        self.verticalLayout_5.addLayout(self.horizontalLayout_18)
        self.horizontalLayout_19 = QtGui.QHBoxLayout()
        self.horizontalLayout_19.setObjectName("horizontalLayout_19")
        self.label_PrevStatus = QtGui.QLabel(self.widget)
        self.label_PrevStatus.setObjectName("label_PrevStatus")
        self.horizontalLayout_19.addWidget(self.label_PrevStatus)
        self.textBrowser_PrevStatus = QtGui.QTextBrowser(self.widget)
        self.textBrowser_PrevStatus.setObjectName("textBrowser_PrevStatus")
        self.horizontalLayout_19.addWidget(self.textBrowser_PrevStatus)
        ...
        self.groupBox_Filters.setGeometry(QtCore.QRect(10, 10, 809, 91))
        ...
        self.groupBox_Violations.setGeometry(QtCore.QRect(10, 100, 809, 211))
        self.groupBox_Violations.setMinimumSize(QtCore.QSize(809, 171))
        self.groupBox_Violations.setObjectName("groupBox_Violations")
        self.layoutWidget2 = QtGui.QWidget(self.groupBox_Violations)
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 20, 791, 181))
        ...
        self.label_Filename = QtGui.QLabel(self.layoutWidget2)
        self.label_Filename.setObjectName("label_Filename")
        self.verticalLayout_7.addWidget(self.label_Filename)
        self.textBrowser_Filename = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_Filename.setObjectName("textBrowser_Filename")
        self.verticalLayout_7.addWidget(self.textBrowser_Filename)
        self.horizontalLayout_12.addLayout(self.verticalLayout_7)
        self.verticalLayout_8 = QtGui.QVBoxLayout()
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.label_Function = QtGui.QLabel(self.layoutWidget2)
        self.label_Function.setObjectName("label_Function")
        self.verticalLayout_8.addWidget(self.label_Function)
        self.textBrowser_Function = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_Function.setObjectName("textBrowser_Function")
        self.verticalLayout_8.addWidget(self.textBrowser_Function)
        ...
        self.textBrowser_Severity = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_Severity.setObjectName("textBrowser_Severity")
        self.verticalLayout_9.addWidget(self.textBrowser_Severity)
        self.horizontalLayout_12.addLayout(self.verticalLayout_9)
        self.verticalLayout_10 = QtGui.QVBoxLayout()
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.label_Id = QtGui.QLabel(self.layoutWidget2)
        self.label_Id.setObjectName("label_Id")
        self.verticalLayout_10.addWidget(self.label_Id)
        self.textBrowser_Id = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_Id.setObjectName("textBrowser_Id")
        self.verticalLayout_10.addWidget(self.textBrowser_Id)
        self.horizontalLayout_12.addLayout(self.verticalLayout_10)
        self.verticalLayout_11 = QtGui.QVBoxLayout()
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.label_DetectedBy = QtGui.QLabel(self.layoutWidget2)
        self.label_DetectedBy.setObjectName("label_DetectedBy")
        self.verticalLayout_11.addWidget(self.label_DetectedBy)
        self.textBrowser_DetectedBy = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_DetectedBy.setObjectName("textBrowser_DetectedBy")
        self.verticalLayout_11.addWidget(self.textBrowser_DetectedBy)
        self.horizontalLayout_12.addLayout(self.verticalLayout_11)
        self.verticalLayout_14.addLayout(self.horizontalLayout_12)
        self.textBrowser_Description = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_Description.setObjectName("textBrowser_Description")
        self.verticalLayout_14.addWidget(self.textBrowser_Description)
        self.textBrowser_Details = QtGui.QTextBrowser(self.layoutWidget2)
        self.textBrowser_Details.setObjectName("textBrowser_Details")
        self.verticalLayout_14.addWidget(self.textBrowser_Details)
        self.horizontalLayout_13 = QtGui.QHBoxLayout()
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.horizontalScrollBar = QtGui.QScrollBar(self.layoutWidget2)
        self.horizontalScrollBar.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalScrollBar.setObjectName("horizontalScrollBar")
        self.horizontalLayout_13.addWidget(self.horizontalScrollBar)
        self.pushButton_GotoCode = QtGui.QPushButton(self.layoutWidget2)
        ...
        self.widget1 = QtGui.QWidget(self.tab_Reports)
        self.widget1.setGeometry(QtCore.QRect(30, 100, 737, 111))
        ...
        self.label_srcCode = QtGui.QLabel(self.widget1)
        self.label_srcCode.setObjectName("label_srcCode")
        self.horizontalLayout_7.addWidget(self.label_srcCode)
        self.textBrowser_ReportFile = QtGui.QTextBrowser(self.widget1)
        ...
        self.pushButton_BrowseSrcCode = QtGui.QPushButton(self.widget1)
        ...
        self.label_reportDir = QtGui.QLabel(self.widget1)
        self.label_reportDir.setObjectName("label_reportDir")
        self.horizontalLayout_8.addWidget(self.label_reportDir)
        self.textBrowser_ReportDir = QtGui.QTextBrowser(self.widget1)
        ...
        self.pushButton_BrowseReport = QtGui.QPushButton(self.widget1)
        ...
        spacerItem4 = QtGui.QSpacerItem(228, 88, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.pushButton_GenerateReport = QtGui.QPushButton(self.widget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(QtGui.QApplication.translate("MainWindow", "TOTAL number of violations :", None, QtGui.QApplication.UnicodeUTF8))
        self.label_13.setText(QtGui.QApplication.translate("MainWindow", "Number of records Accepted :", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setText(QtGui.QApplication.translate("MainWindow", "Number of records Reviewed :", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_Statistics.setText(QtGui.QApplication.translate("MainWindow", "Update Statistics", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_prevName.setText(QtGui.QApplication.translate("MainWindow", "Previous Reviewer", None, QtGui.QApplication.UnicodeUTF8))
